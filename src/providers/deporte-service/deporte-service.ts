...
public newDeporte(token,postParams){
  
      let body='iddeporte='+postParams.iddeporte+'&nombredeporte='+postParams.nombredeporte;
      ...
      return new Promise ((resolve, reject)=>{
        this.http.post('http://139.162.118.169:8080/proyectoAndroid/webresources/com.android.entidades.deporte',body,optionspost)
        .subscribe(res=>{
          resolve(res);
        },(err)=>{
          resolve(err);
